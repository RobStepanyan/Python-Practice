...
1. Tuple-ը հայտարարվում է list-ի նման, քառակուսի փակագծերի փոխարեն օգտագործելով սովորական փակագիծ:
...
Տեխնիկալ տերմիններով ասած imutable: Պրակտիկորեն ասած, նրանք չունեն այնպիսի մեթոդներ, որոնք
...
Այսպիսով ո՞րն է tuple-ի առավելությունը:
    ...
    Այսպես ձեր կոդը կլինի ավելի ապահով, քանի որ արժեքները, որոնք պետք չէ
